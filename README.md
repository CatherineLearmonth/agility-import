...
To get the xml input, you will require the Agility PIM, along with Agility PIM's syndication server, full exporter and adapter code. If you need a PIM system along with Magento, then this extension with Agility PIM is the ideal solution. 
